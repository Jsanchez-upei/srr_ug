...
+--------------------------------+----------------------------------------------------------------------------------------------------------------------------+
| [NEW]{style="color:#0d6efd"}   | Check here if you wish to create a new model and assign a Model name.                                                      |
+--------------------------------+----------------------------------------------------------------------------------------------------------------------------+
...
+--------------------------------+----------------------------------------------------------------------------------------------------------------------------+
| [SAVE]{style="color:#0d6efd"}  | [@Robert: consider change of button name] Save the model, results or the model report to your local system.       |
+--------------------------------+----------------------------------------------------------------------------------------------------------------------------+
| [ABOUT]{style="color:#0d6efd"} | [@Robert: consider change of button name] Check out here for important information about the app .                |
+--------------------------------+----------------------------------------------------------------------------------------------------------------------------+
...
- a step-by-step process for creating a model in shiny rrisk session. 
:::
...
[@Robert: Please use "Add Node" instead of Add new item]
...
[@MG[:move this after read more? or as another Tip callout?]{.mark}]
...
The first option allows you to define a node using a mathematical expression (@fig-NodeUserDefined).
...
![](images/uncheckstrechgraph_collapse.png){style="border: 2px solid black;  box-shadow: 4px 4px 12px rgba(0, 0, 0, 0.6);" width="500"}
