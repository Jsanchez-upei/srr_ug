...
The rrisk distributions supports two approaches for fitting a distribution, which are technically related to a probability density function (pdf) or cumulative density function (cdf) .
