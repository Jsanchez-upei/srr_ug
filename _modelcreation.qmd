...
![Bootstrapping of the mean and standard deviation of individual consumption data (see text for more details).](images/BootstrapNode2.png){#fig-BootstrapNode2 width="100%"}
...
![Using a joint bootstrap distribution for mean and standard deviation to parameterise a new node for varaibility (see text for more details).](images/ARSnodeC.png){#fig-ARSnodeC width="100%"}
