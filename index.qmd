...
<!-- shadow added to screenshot in MS-Word: offset centre, 60%, 102%, 5pt, 0, 0pt -->
...
A model in shiny rrisk consists of so-called nodes. The user may also define fixed parameters and functions available for the definition of nodes.
...
-   the integrated annotation template that will guide you through a comprehensive documentation of each node.
:::
...
| [Description]{style="color:#0d6efd"}                 | All relevant information required for documentation and verification should be provided. This may include any underlying assumptions and uncertainties. The text may be structured using sub-headers (see example for markdown syntax below).                                                                                               |
...
-   defining a node a node in shiny rrisk, which is the essential tasks in model creation.
:::


![Mathematical part of node definition.](MathematicalDefinition.png){#fig-MathematicalDefinition width="100%"}

Several options are available for defining the mathematical properties of a node, including user defined, parametric distribution, bootstrapping and import from rrisk distribution fitting. 

The first option [user defined]{.underline} allows you to define a node using a mathematical expression (@fig-NodeUserDefined).
...
@JS we'll fix that later because we should be consistent with the entry in the drop down menu  ---> 
...
![Bootstrap nodes always represent parameter uncertainty.](BootstrapNode1.png){#fig-BootstrapNode1 width="100%"}
...
![Bootstrapping of the mean and standard deviation of individual consumption data (see text for more details).](BootstrapNode2.png){#fig-BootstrapNode2 width="100%"}

|                                            |                                                                                                                                                                                                                                                           |
|---------------|---------------------------------------------------------|
| [Open data]{style="color:#0d6efd"}         | [@Robert: please capitalise "open" and check the file requirements] A local csv-data file may be uploaded as source data. The comma-separated data file should use decimal point “.”, must not contain a variable name and consist of only one column. \| |
...
| [Node name]{style="color:#0d6efd"}         | [@Robert: please consider change to Node name] Up to five nodes can be defined which will be automatically generated and contain the joint bootstrap distribution. \|                                                                                     |
| [Summary statistic]{style="color:#0d6efd"} | [@R=: please capitalise "summary"] For each node a proper name of the requested statistic is to be provided using R terminology. \|                                                                                                                       |
...
![Using a joint bootstrap distribution for mean and standard deviation to parameterise a new node for varaibility (see text for more details).](ARSnodeC.png){#fig-ARSnodeC width="100%"}
:::
...
![Schematic representation of the bootstrap method (Greiner, 2022, unpublishes course notes).](BootstrapConcept.png){#fig-BootstrapConcep width="80%"}
...
![](images/simulation.png){style="border: 2px solid black;  box-shadow: 4px 4px 12px rgba(0, 0, 0, 0.6);"}
