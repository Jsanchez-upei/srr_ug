...
|                                            |                                                                                                                                                                                                                                                                        |
|---------------|---------------------------------------------------------|
| [Open data]{style="color:#0d6efd"}         | @Robert[:]{.mark}[ please capitalise "open" and check the file requirements]{.mark} A local csv-data file may be uploaded as source data. The comma-separated data file should use decimal point “.”, must not contain a variable name and consist of only one column. |
...
| [Node name]{style="color:#0d6efd"}         | @Robert[:]{.mark}[ please consider change to Node name]{.mark}Up to five nodes can be defined which will be automatically generated and contain the joint bootstrap distribution.                                                                                      |
| [Summary statistic]{style="color:#0d6efd"} | @Robert[:]{.mark}[ please capitalise "summary"]{.mark}For each node a proper name of the requested statistic is to be provided using R terminology.                                                                                                                    |
...
@Robert[ or Thomas to contribute]{.mark} Brief description of the EFSA EKE or more description how shiny rrisk deals with EKE more generally.
:::
