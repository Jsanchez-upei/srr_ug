...
After nodes are created, the following table will be created in shiny rrisk containing a the information of each node in the model.
...
@Robert - change set run parameter to Set simulation

Before executing (run) the simulation, user can set up several parameters as presented below. After setting these parameters, click **Change Parameter.**

+-----------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------+
| [SAMPLING TECHNIQUE]{style="color:#0d6efd"}                                             | Check here if you wish to create a new model and assign a Model name.                                 |
+-----------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------+
...
select the appropriate number of samples. shiny rrisk might not run if the memory is above \@\@\@
:::

::: {.callout-tip collapse="true"}
### Good practice

-   Setting the number of samples --\> conv. plot
:::

## General Results

add Interpretation of results, with brief mention of main elements for interpretation to have this in the main text
...
-MCMC sampling, 1D and 2D , Tables interpretation -MCMC Plots – Cumulative. Convergence plots,
:::
