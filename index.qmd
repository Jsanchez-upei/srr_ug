...
### Example for markdown syntax (Alizarin red S in Eel model)
...
@MG/RO[ - define Circle represents and squares - Is there any standards?]{.mark}
...
|  |  |
|----|----|
| [Open data]{style="color:#0d6efd"} | @Robert [:][please capitalise "open" and check the file requirements]{.mark} A local csv-data file may be uploaded as source data. The comma-separated data file should use decimal point “.”, must not contain a variable name and consist of only one column. |
...
| [Node name]{style="color:#0d6efd"} | @Robert [:][please consider change to Node name]{.mark}Up to five nodes can be defined which will be automatically generated and contain the joint bootstrap distribution. |
| [Summary statistic]{style="color:#0d6efd"} | @Robert [:][please capitalise "summary"]{.mark}For each node a proper name of the requested statistic is to be provided using R terminology. |
