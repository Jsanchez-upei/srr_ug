...
Launching the simulation will bring you to your modelling results. 

![Launching the simulation.](images/simulation.png){#fig-simulation width="100%"}

Before running the simulation, you may [set run parameters]{.underline} to increase the efficiency and control the reproducibility of your model. 


![Adjustment and control of simulation parameters](images/setrunparameter.png){#fig-setrunparameter fig-align="left" width="60%"}

|                                                                                         |                                                                                                       |
|---------------------------------|--------------------------------------|
| [Sampling technique]{style="color:#0d6efd"}                                             | Choose between Monte-Carlo (default) and latin hypercube (enhanced efficiency)             |
| [Number of Monte Carlo replicates for variability]{style="color:#0d6efd"} | Enter the number of random samples for nodes reflecting variability                        |
| [Number of Monte Carlo replicates for uncertainty]{style="color:#0d6efd"} | Enter the number of random samples for nodes reflecting uncertainty                        |
| [Seed value]{style="color:#0d6efd"}                                                     | Enter an integer number, which will allow to reproduce the random sampling results  | [Quantiles]{style="color:#0d6efd"}                         | Enter comma-sparated  percentiles for summarizing model results in the variability (1D) and uncertainty (2D) |
                  |
