...
The empirical cumulative density function (ECDF) plot visualizes the distribution whereby the quantiles can be read from the y-axis. This feature allows the visualisation of the uncertainty of the outcome distribution. Thus, there is a principal difference in appearance and interpretation of the ECDF plot between 1D and 2D models. In case of 2D models the 95th (or other percentile) uncertainty envelope is shown (@fig-ecdf). 
